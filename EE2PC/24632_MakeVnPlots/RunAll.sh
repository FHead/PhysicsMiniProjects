   ...
   do
      ...
      do
         ./Execute \
            ...
            --Color -${VN},-${VN} \
            --Marker 20,1 \
            --Text 0.15,0.86,"#font[52]{Preliminary}",0.15,0.81,"$String" \
         ...
         ./Execute \
            ...
            --Title ";p_{T} (GeV);#sqrt{#Deltav_{$VN}^{2}}" \
            --XMin 0 --XMax 4.5 --AutoY true \
            --Color -${VN} \
            --Marker 20 \
            --Text 0.15,0.86,"#font[52]{Preliminary}",0.15,0.81,"$String" \
      ...
      ./Execute \
         ...
         --Curve Data_${T}_Multiplicity_${R}_v1,MC_${T}_Multiplicity_${R}_v1,Data_${T}_Multiplicity_${R}_v2,MC_${T}_Multiplicity_${R}_v2,Data_${T}_Multiplicity_${R}_v3,MC_${T}_Multiplicity_${R}_v3 \
         --Label "Data v_{1}","Archived MC","v_{2}","None","v_{3}","None" \
         --Type 1,0,1,0,1,0 \
         --Output Plots/${T}_Multiplicity_${R}_v123 \
         --Title ";p_{T} (GeV);v_{n}" \
         --XMin 0 --XMax 4.5 --YMin -3.0 --YMax 3.0 \
         --Color -1,-1,-2,-2,-3,-3 \
         --Marker 20,1,20,1,20,1 \
         --Text 0.15,0.86,"#font[52]{Preliminary}",0.15,0.81,"$String" \
   ...
   do
      ...
      do
         ...
         ./Execute \
            ...
            --Title ";Multiplicity;#sqrt{#Deltav_{$VN}^{2}}" \
            --XMin 9 --XMax 75 --AutoY true \
            --Color -${VN} \
            --Marker 20 \
            --Text 0.15,0.86,"#font[52]{Preliminary}",0.15,0.81,"$String" \
      ...
      ./Execute \
         --File Graphs.root,Graphs.root,Graphs.root,Graphs.root,Graphs.root,Graphs.root \
         --Curve Data_${T}_PT_${R}_v1,MC_${T}_PT_${R}_v1,Data_${T}_PT_${R}_v2,MC_${T}_PT_${R}_v2,Data_${T}_PT_${R}_v3,MC_${T}_PT_${R}_v3 \
         --Label "Data v_{1}","Archived MC","v_{2}","None","v_{3}","None" \
         --Type 1,0,1,0,1,0 \
